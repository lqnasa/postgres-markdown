package com.coder.lee.postgresmarkdown.config;
...
public class GlobalExceptionTranslator {
    ...
    public ResponseEntity handleError(Throwable e) {
        ...
        String message = Optional.ofNullable(e).map(Throwable::getCause).map(Throwable::getMessage).orElse(e.getMessage());
        message = String.format("%s:\n%s", HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase(), message);
